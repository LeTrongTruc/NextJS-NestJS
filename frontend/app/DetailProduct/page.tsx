...
import Body from "@/components/detailProuduct";
...
async function LoadDataProduct(id: string): Promise<any> {
    const data = await POST("/product/detailProduct", { id });
    return data;
}
